...
namespace Cliver.PdfMailer2
{
    public partial class SettingsForm : Form
    {
        ...
        private void bSaveBuyer_Click(object sender, EventArgs e)
        {

        }

        private void bDeleteBuyer_Click(object sender, EventArgs e)
        {

        }

        private void saveParty_Click(object sender, EventArgs e)
        {
